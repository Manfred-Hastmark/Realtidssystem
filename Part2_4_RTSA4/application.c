...
void tapTheTempo(App*, int);

#ifdef LAB0
int receiveKey(App*, int);
...
void defaultLab(int c);
#endif

#if defined(CONDUCTOR) || defined(MUSICIAN)
void CANkeyReceiver(int c);
#endif
