...
#define initThreeHist() {initObject(), {}, 0, 0}
...
#define initMelody(melody, length) {initObject(), (int*)melody, (int)length, 0}
...
#define initMelodyGeneral(melody, length) {initObject(), {}, (int*)melody, (int)length, 0, 0, 0}
